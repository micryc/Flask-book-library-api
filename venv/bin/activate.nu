...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/michal/PycharmProject/Flask-book-library-api/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/michal/PycharmProject/Flask-book-library-api/venv/bin/deactivate.nu'
